...
<div class="sidebar">
    <div class=" sidebar-wrapper">
        <div class="logo">
            {{--            <a>--}}
            {{--                <img class="logoimg" src="{{asset('site_logo.png')}}" style="width:200px"/>--}}
            {{--            </a>--}}
        ...
        <ul class="nav">
            ...
            <li>
                ...
                <div
                    class="{{ Request::is( 'settings/profile') || Request::is( 'settings/allusers') || Request::is( 'settings/application') ? 'collapse in' : 'collapse' }}"
                    id="settings"
                    aria-expanded="{{ Request::is( 'settings/profile') || Request::is( 'settings/allusers') || Request::is( 'settings/application') ? 'true' : 'false' }}"
...
<div class="main-panel">
    <nav class="navbar navbar-expand-lg navbar-light bg-light pl-4 pr-4">
        ...
        <div class="col-md-6 ">
            ...
            <button class="navbar-toggler nav-toggler-mobile" type="button" data-toggle="collapse" data-target="#menu"
                    aria-controls="menu"
